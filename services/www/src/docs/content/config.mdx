...
Load additional instruction files, glob patterns, or HTTP(S) URLs alongside
...
See the [instructions guide](/instructions) for path resolution, project instructions, and `AGENTS.md`.
